...
HttputilDocument {
    ...
    public <T> void protocolBuffer(final Context context,
                                   final String url, final Document.ReqDocument index, final Object ob) {
        /**提示*/
        ...
        Observable.create(new Observable.OnSubscribe<Document.ReqDocument>() {
            @Override
            public void call(final Subscriber<? super Document.ReqDocument> subscriber) {
                //创建子线程加载数据
...
/**设置时间*/
                    ...
                    if (HttpURLConnection.HTTP_OK == responseCode) {
                        ...
                        if (inputStream != null) {
                            Document.ReqDocument jhon1 = Document.ReqDocument.parseFrom(inputStream);
...
//                Document.FileList.Builder fileList = Document.FileList.newBuilder();
                ...
                .subscribe(new Subscriber<Document.ReqDocument>() {
                    @Override
                    ...
                    @Override
                    public void onNext(Document.ReqDocument reqIndex) {
...
//                        }
    ...
    public abstract <T> void analysisInputStreamData(Document.ReqDocument index) throws IOException;
