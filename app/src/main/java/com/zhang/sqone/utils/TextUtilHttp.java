...
TextUtilHttp {
    ...
    public <T> void protocolBuffer(final Context context,
                                   final String url, final Test1.ReqTest11 index, final Object ob) {
        /**提示*/
        ...
        Observable.create(new Observable.OnSubscribe<Test1.ReqTest11>() {
            @Override
            public void call(final Subscriber<? super Test1.ReqTest11> subscriber) {
                //创建子线程加载数据
...
//                Document.FileList.Builder fileList = Document.FileList.newBuilder();
                ...
                .subscribe(new Subscriber<Test1.ReqTest11>() {
                    @Override
                    ...
                    @Override
                    public void onNext(Test1.ReqTest11 reqIndex) {
